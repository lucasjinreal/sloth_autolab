...
class BaseCommand(object):
    ...
    1. ``sloth_autolab-cli` loads the command class
    ...
    option_list = (
        ...
        make_option('-c', '--config',
            help='The Python path to a configuration file, e.g. "myconfig". If this isn\'t provided, sloth_autolab\'s default configuration will be used.'),
    ...
    def run_from_argv(self, argv):
        ...
        and sloth_autolab configuration), then run this command.
        """
